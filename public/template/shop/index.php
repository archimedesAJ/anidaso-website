...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/anidaso-logo.png" />
    ...
    <!-- Favicons -->
    <link href="../assets/img/anidaso-logo.ico" rel="icon">
    <link href="../assets/img/anidaso-logo.ico" rel="apple-touch-icon">
</head>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img style=" width: 90px; height: 80px;" src="assets/images/anidaso-logo.png" alt="Logo">
                        </a>
                        <!-- End Header Logo -->
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="assets/images/products/fowls.jpeg" alt="#">
                            <div class="button">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="assets/images/products/dressed.jpeg" alt="#">
                            <div class="button">
                                <a href="https://wa.me/+233504489207" class="btn"><i class="lni lni-whatsapp"></i> Ask In WhatsApp</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="assets/images/products/dressed_cut.jpeg" alt="#">
                            <div class="button">
                                <a href="https://wa.me/+233504489207" class="btn"><i class="lni lni-whatsapp"></i> Ask In WhatsApp</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="assets/images/products/eggs.jpeg" alt="#">
                            <div class="button">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-12">
                            <div class="footer-logo">
                                <a href="index.php">
                                    <img style=" width: 90px; height: 80px;" src="assets/images/anidaso-logo.png" alt="#">
                                </a>
                            </div>
                        </div>
